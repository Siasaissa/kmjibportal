...
<head>
  ...
  <link href="{{ asset ('board_files/quotation_.css')}}" rel="stylesheet">
</head>
          ...
          <div class="card-body">
            ...
            <form id="quotationForm" method="post" action="{{ route('quotations.store') }}" enctype="multipart/form-data">
              ...
              <div class="step-content">
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                      <label class="form-label required-field">Client Full Name</label>
                      <input type="text" 
                            class="form-control client-autocomplete" 
                            id="quotation_client_name" 
                            name="client_name" 
              ...
              <div class="step-content d-none">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6 form-check">
                    <input class="form-check-input" type="checkbox" name="fronting_business">
              ...
              <div class="step-content d-none">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-4 form-check">
                    <input class="form-check-input" type="checkbox" name="apply_depreciation">
              ...
              <div class="step-content d-none">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-12">
                    ...
                    <input class="form-control bg-light" name="total_premium" type="number" readonly>
                  </div>
                  <div class="col-md-12">
        ...
        <div class="modal-content">
          ...
          <!--<form action="{{url('/dash/Quotation')}}">-->
            ...
            <div class="modal-footer px-4">
              ...
              <a href="{{ url('/dash/Quotation') }}"><button type="button" class="btn btn-primary text-white">Skip</button></a>
            </div>
          </form>
        </div>
      </div>
