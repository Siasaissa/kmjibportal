                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                            <div class="mb-4 mb-md-0">
                                <div class="d-flex align-items-center mb-3">
                                    <h1 class="h2 mb-0">
                                        <i class="bi bi-box fs-2 section-icon me-3"></i>
                                        Product
                                    </h1>
                                </div>
                                    ...
                                    <div class="card-toolbar ms-4 d-flex align-items-center gap-1">
                                        <a href="#" style="color: white;">
                                            <button class="btn btn-sm bg-danger text-white" data-bs-toggle="modal"
                                                ...
                                                <i class="fas fa-plus text-white"></i> Add New Product
                                            </button>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <table class="table table align-items-center border-danger"
                                ...
                                <thead>
                                    <tr class="fs-5 fw-bold text-dark border-bottom-2 ">
                                        ...
                                        <th class=" min-w-100px text-center ">Min Premium</th>
                                ...
                                <tbody>
                                    <tr class=" border-bottom-2">
                                        ...
                                        <td class="text-gray-600 fs-6 text-center">AAR Insurance</td>
                                        <td class="text-gray-600 fs-6 text-center">100,000</td>
                                        ...
                                        <td class="text-center gap-3">
                                            <i class="bi bi-pencil-square fs-4 me-4 cursor-pointer text-warning"
                                                data-bs-toggle="modal" data-bs-target="#editModal"></i>
                                            <i class="bi bi-trash fs-4 text-danger ms-4 cursor-pointer"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-danger text-white">
                            <h5 class="modal-title" id="editModalLabel">Edit Product Info</h5>
                        ...
                        <form id="editForm">
                            <div class="modal-body row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="Health Insurance">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Type</label>
                                    <input type="text" class="form-control" value="Health">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Company</label>
                                    <input type="text" class="form-control" placeholder="AAR Insurance">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">100,000.00</label>
                                    <input type="text" class="form-control" placeholder="AAR Insurance">
                                </div>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Are you sure you want to delete <strong>Health Insurance</strong>'s record? This action
                            cannot be
                            undone.
                        </div>
                        <div class="modal-footer">
