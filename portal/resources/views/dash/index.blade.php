        ...
        <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="d-flex justify-content-center ms-4 me-15 ">
                                    ...
                                    <div class="d-flex fw-bold text-primary ms-4 menu-link"
                                        ...
                                        <a href="#" style="text-decoration: none; color: inherit;"><span>Messages |
                                                10081</span></a>
                                    </div>
                                    <!--
                                    <div class="d-flex fw-bold text-primary ms-4 menu-link">
                                ...
                                <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                                    ...
                                    <div class="symbol-label bg-primary text-white fw-bold fs-4 d-flex align-items-center justify-content-center rounded-circle"
                                        style="width: 50px; height: 50px; cursor: pointer;" data-bs-toggle="popover"
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-18 ">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div
                                        ...
                                        <div class="h-55px d-flex align-items-center justify-content-center">
                                            <span class="fs-5 fw-bold"
                                                style="color: rgb(12, 12, 138) !important;">Insurance</span>
                                        </div>
                                        <!-- Floating label -->
                                    </div>
                                    ...
                                    <a href="#" class="btn btn-icon btn-danger h-55px w-55px" data-bs-toggle="modal"
                                        data-bs-target="#dashmodal" title="New product">
                                        <i class="fas fa-plus fs-2 text"></i>
                                    </a>
                                    ...
                                    <div class="col-xl-4 mb-10">
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                                                style="background: linear-gradient(135deg, #d4141c 0%, #8e0e1d 30%, #001538 100%);
           ...
           animation: gradientShift 10s ease infinite;" data-bs-theme="light">
                                                ...
                                                <h3 class="card-title align-items-start flex-column text-white pt-15">
                                                    <span class="fw-bold fs-2x mb-3">Premium (Ex VAT)</span>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <i
                                                                                class="bi bi-house fs-1 fw-bold text-primary "></i>
                                                                        </span>
                                                                    </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-fullscreen-exit fs-1 fw-bold text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-person-plus fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-archive fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-journal-text fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                            class="text-gray-700 fw-bolder d-block fs-9 text-nowrap">Risknote</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-repeat fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-briefcase fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-file-earmark-medical fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-person fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-arrow-clockwise fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-file-earmark-break fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                            class="text-gray-700 fw-bolder d-block fs-9 text-nowrap">Profoma</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-download fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                            class="text-gray-700 fw-bolder d-block fs-9 text-nowrap">Download</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-chat-left-text fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-x-square fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger rounded-3">
                                                                            <i
                                                                                class="bi bi-award fs-1 text-primary"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <span
                                                                            class="text-gray-700 fw-bolder d-block fs-9 text-nowrap">Commission</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div class="col-4 d-flex justify-content-center">
                                                            <a href="{{url('/dash/Settings')}}"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="text-center">
                                                                        <span
                                                                            class="text-gray-700 fw-bolder d-block fs-9 text-nowrap">Settings</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                            ...
                                                            <div class="carousel-item active show">
                                                                <div class="d-flex align-items-center mb-9">
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger shadow-sm">
                                                                            <i class="bi bi-fullscreen-exit fs-3x text-danger position-relative"
                                                                                style="z-index: 1;">
                                                                            ...
                                                                            <!-- Glow effect -->
                                                                            <span
                                                                                class="position-absolute top-0 start-0 w-100 h-100 rounded-circle bg-danger opacity-10 animate-pulse"></span>
                                                                        </span>
                                                                    </div>

                                                                    <div class="m-0">
                                                                        <h4
                                                                            class="fw-bold text-danger mb-3 animate__animated animate__fadeInRight">
                                                                            Branches
                                                                        </h4>
                                                                        ...
                                                                        <div class="d-flex d-grid gap-5">
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex align-items-center fs-10 fw-bold text-gray-500 mb-2 animate__animated animate__fadeInUp"
                                                                                    ...
                                                                                    <span
                                                                                        class="fs-1 text-danger ms-1">5</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="carousel-item ">
                                                                <div class="d-flex align-items-center mb-9">
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger shadow-sm">
                                                                            <i class="bi bi-person-plus fs-3x text-danger position-relative"
                                                                                style="z-index: 1;">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        ...
                                                                        <div class="d-flex d-grid gap-5">
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2 animate__animated animate__fadeInUp"
                                                                                    ...
                                                                                    <span
                                                                                        class="fs-2 text-danger ms-1">101</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="carousel-item ">
                                                                <div class="d-flex align-items-center mb-9">
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger shadow-sm">
                                                                            <i class="bi bi-person fs-3x text-danger position-relative"
                                                                                style="z-index: 1;">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        ...
                                                                        <div class="d-flex d-grid gap-5">
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2 animate__animated animate__fadeInUp"
                                                                                    ...
                                                                                    <span
                                                                                        class="fs-2 text-danger ms-1">1,000</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="carousel-item active show">
                                                                ...
                                                                <div class="d-flex align-items-center mb-9">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger shadow-sm">
                                                                            <i class="bi bi-briefcase fs-3x text-danger position-relative"
                                                                                style="z-index: 1;">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        ...
                                                                        <div class="d-flex d-grid gap-5">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2 animate__animated animate__fadeInUp"
                                                                                    ...
                                                                                    <span
                                                                                        class="fs-2 text-danger ms-1">10,000.00</span>
                                                                                </div>
                                                            ...
                                                            <div class="carousel-item ">
                                                                ...
                                                                <div class="d-flex align-items-center mb-9">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger shadow-sm">
                                                                            <i class="bi bi-check-all fs-3x text-danger position-relative"
                                                                                style="z-index: 1;">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                            ...
                                                            <div class="carousel-item ">
                                                                ...
                                                                <div class="d-flex align-items-center mb-9">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="symbol-label bg-light-danger shadow-sm">
                                                                            <i class="bi bi-award fs-3x text-danger position-relative"
                                                                                style="z-index: 1;">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        ...
                                                                        <div class="d-flex d-grid gap-5">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2 animate__animated animate__fadeInUp"
                                                                                    ...
                                                                                    <span
                                                                                        class="fs-2 text-danger ms-1">100,000.00</span>
                                                                                </div>
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-900">Top Customer</span>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <!--begin::Text-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Juma
                                                                Bakari</a>
                                                            <!--end::Text-->
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <!--begin::Text-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">John
                                                                Japhet</a>
                                                            <!--end::Text-->

                                                            <!--begin::Description-->
                                                            <span
                                                                class="text-gray-500 fw-semibold d-block fs-6">129,000</span>
                                                            <!--end::Description--->
                                                        </div>
                                                        <!--end::Section-->
                                                    </div>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <!--begin::Text-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Rose
                                                                Katikiro</a>
                                                            <!--end::Text-->

                                                            <!--begin::Description-->
                                                            <span
                                                                class="text-gray-500 fw-semibold d-block fs-6">1,027,000</span>
                                                            <!--end::Description--->
                                                        </div>
                                                        <!--end::Section-->
                                                    </div>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <!--begin::Text-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Husna
                                                                Jimmy</a>
                                                            <!--end::Text-->

                                                            <!--begin::Description-->
                                                            <span
                                                                class="text-gray-500 fw-semibold d-block fs-6">1,000,000</span>
                                                            <!--end::Description--->
                                                        </div>
                                                        <!--end::Section-->
                                                    </div>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <!--begin::Text-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Bakari
                                                                Athumani</a>
                                                            <!--end::Text-->

                                                            <!--begin::Description-->
                                                            <span
                                                                class="text-gray-500 fw-semibold d-block fs-6">990,000</span>
                                                            <!--end::Description--->
                                                        </div>
                                                        <!--end::Section-->
                                                    </div>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <!--begin::Text-->
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Kuznet
                                                                Pius</a>
                                                            <!--end::Text-->

                                                            <!--begin::Description-->
                                                            <span
                                                                class="text-gray-500 fw-semibold d-block fs-6">930,000</span>
                                                            <!--end::Description--->
                                                        </div>
                                                        <!--end::Section-->
                                                    </div>
                                                        ...
                                                        <tr class="text-gray-600 fs-6 text-center border-bottom-2">
                                                            ...
                                                            <td class="text-center">
                                                                <div
                                                                    ...
                                                                    <i class="bi bi-eye fs-4 cursor-pointer me-4 text-warning"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#more"></i></a>
                                                                    <i class="bi bi-printer fs-4"></i></a>
                                                                </div>
                                                            </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-4 fs-2">
                        <div class="col-md-4">
                            <div class="card-box bg-light-danger">Motor</div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-box bg-light-danger">Miscellaneous & Accidents</div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-box bg-light-danger">Marine</div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-box bg-light-danger">Goods In Transit</div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-box bg-light-danger">Fire</div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-box bg-light-danger">Engineering</div>
                        </div>
                    </div>
                </div>
